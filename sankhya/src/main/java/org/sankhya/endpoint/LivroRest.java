...
public class LivroRest {
	...
	public Response getLivrosPorUsuario(@Context HttpServletRequest request) {
		...
		return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possível buscar a lista de livros").build();
	}
	...
	public Response getLivro(@PathParam("id") Integer id) {
		...
		return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possivel localizar o livro id: " + id).build();
	}
	...
	public Response adicionarLivro(LivroDto livroDto, @Context HttpServletRequest request) {
		...
		return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possivel cadastrar o livro: " + livroDto.getTitulo()).build();
	}
	...
	public Response removerLivro(LivroDto livroDto) {
		...
		return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possivel remover o livro: " + livroDto.getTitulo()).build();
	}
	...
	public Response temLivros(@Context HttpServletRequest request) {
		...
		return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possivel localizar a estante de livros").build();
	}
