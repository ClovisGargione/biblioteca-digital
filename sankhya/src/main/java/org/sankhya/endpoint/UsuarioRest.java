...
public class UsuarioRest {
	...
	return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possível encontrar o usuário")
		.build();
    }
	...
	try {
	    Usuario usuario = new Usuario(null, usuarioDto.getLogin(), usuarioDto.getNome(),
		    PasswordService.hashPassword(usuarioDto.getSenha()));
	    usuarioFacade.adicionar(usuario);
	    return Response.ok().build();
	} catch (Exception e) {
	    logger.error("Nao foi possivel cadastrar o usuário:" + e.getMessage());
	}
	return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possível cadastrar o usuário")
		.build();
    }
	...
	return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possível atualizar o usuário")
		.build();
    }
	...
	return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Não foi possível remover o usuário")
		.build();
    }
	...
	return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
		.entity("Não foi possível buscar a lista de usuários").build();
    }
