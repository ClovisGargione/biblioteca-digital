...
public class AutenticacaoRest {
	...
	try {
	    ...
	    if (foundUser.isPresent()
		    && PasswordService.checkPassword(informacoesLogin.getSenha(), foundUser.get().getSenha())) {
	...
	return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Nao foi possivel cadastrar o usuario")
		.build();
    }
}
